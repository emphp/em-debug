...
use EM;
use em\base\InvalidConfigException;
use em\helpers\FileHelper;
use em\log\Target;
...
class LogTarget extends Target
{
     ...
     * @throws \em\base\InvalidConfigException
     */
     ...
     * @param array $messages log messages to be processed. See [[\em\log\Logger::messages]] for the structure
     * of each message.
    ...
    protected function collectSummary()
    {
        ...
        $request = EM::$app->getRequest();
        $response = EM::$app->getResponse();
        $summary = [
            'tag' => $this->tag,
